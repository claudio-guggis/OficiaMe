    ...
    <div class="contenedor-principal">
                    ...
                    <div class="contenedor-volver">
                        <?php
                            if(isset($_SESSION['type']))
                            {
                                ...
                                {
                                    ?>
                                    <button class="btn-volver" onclick="location.href='trabajador/misservicios.php'">Volver</button>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <button class="btn-volver" onclick="location.href='cliente/cliente.php'">Volver</button>
                                    <?php
                                }
                            }
                            else
        ...
        <!-- <div class="contenedor-volver">
            <?php
                ...
                //    {
                        ?>
                        <a href="trabajador/misservicios.php"><button class="btn-volver">Volver</button></a>
                        <?php
                    // }
                    // else
                    // {
                        ?>
                        <a href="cliente/cliente.php"><button class="btn-volver">Volver</button></a>
                        <?php
                //     }
                // }
                // else
